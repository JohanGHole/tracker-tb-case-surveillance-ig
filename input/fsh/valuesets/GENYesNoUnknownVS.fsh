ValueSet: GENYesNoUnknownVS
Title: "GEN - Yes/No/Unknown value set"
Description: "Value set for DHIS2 'Yes/No/Unknown' option set."
...
* ^version = "1.0.0"
* ^date = "2025-01-06"
* codes from system GENYesNoUnknownCS