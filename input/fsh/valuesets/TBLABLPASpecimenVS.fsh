ValueSet: TBLABLPASpecimenVS
Title: "TB-LAB - LPA specimen value set"
Description: "Value set for DHIS2 'LPA specimen' option set."
...
* ^version = "1.0.0"
* ^date = "2025-01-06"
* codes from system TBLABLPASpecimenCS