ValueSet: TBLABSampleStatusVS
Title: "TB-LAB - Sample status value set"
Description: "Value set for DHIS2 'Sample status' option set."
...
* ^status = #active
* ^experimental = true
* codes from system TBLABSampleStatusCS