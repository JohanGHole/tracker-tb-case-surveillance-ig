ValueSet: TBLABSmearResultVS
Title: "TB-LAB - Smear result value set"
Description: "Value set for DHIS2 'Smear result' option set."
...
* ^version = "1.0.0"
* ^date = "2025-01-06"
* codes from system TBLABSmearResultCS