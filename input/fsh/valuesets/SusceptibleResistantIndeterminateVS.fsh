ValueSet: SusceptibleResistantIndeterminateVS
Title: "Susceptible/Resistant/Indeterminate value set"
Description: "Value set for DHIS2 'Susceptible/Resistant/Indeterminate' option set."
