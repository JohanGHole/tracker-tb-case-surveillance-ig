ValueSet: TBLABMTBTestResultVS
Title: "TB-LAB - MTB test result value set"
Description: "Value set for DHIS2 'MTB test result' option set."
...
* ^version = "1.0.0"
* ^date = "2025-01-06"
* codes from system TBLABMTBTestResultCS